...
def example_complex_patterns():
    ...
    print("1. Spiral...")
    spiral_points = pattern_gen.generate_spiral_points(center_x, center_y, 200, turns=3, steps_per_turn=50)
    ...
    sine_points = pattern_gen.generate_sine_wave_points(
        ...
        length=600, amplitude=100, frequency=2.0, steps=100
    )
    mover.move_smooth_path(sine_points, duration_per_point=0.05)
    time.sleep(1)
    
    print("3. Figure eight...")
    eight_points = pattern_gen.generate_figure_eight(center_x, center_y, 200, 100, steps=100)
...
def example_random_movements():
    ...
    print("1. Random walk...")
    random_points = pattern_gen.generate_random_walk(current_x, current_y, steps=15, max_step_size=80)
